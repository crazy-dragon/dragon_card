...
(function () {
    ...
    var ZH = {
        ...
        'manage.importWarn': '该卡组已有 {n} 张卡片，导入数据将覆盖或移除现有卡片。建议先导出备份，确定继续吗？',
        'manage.importTitle': '覆盖数据？',
        'manage.renamed': '已改名',
    ...
    var EN = {
        ...
        'home.active': 'Active',
        'home.filterAll': 'All',
        'home.filterRecent': 'Recent',
        'home.refresh': 'Refresh decks',
        'home.refreshed': 'Refreshed',
        'home.yearDays': 'days',
        'home.store': 'Store',
        'skin.title': 'Skin',
        ...
        'manage.imported': 'Imported {n} items',
        'manage.exported': 'Exported {n} items',
        'manage.importWarn': 'This deck already has {n} cards. Importing will overwrite or remove existing cards. Export a backup first. Continue?',
        'manage.importTitle': 'Overwrite data?',
